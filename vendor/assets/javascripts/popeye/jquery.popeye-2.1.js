...
(function ($) {
    ...
    $.fn.popeye = function (options) {
        ...
        /*
          (abhinav) : Popeye collects captions for all images in the imglist in an array
          first and thereafter uses that array to pick captions to show. 

          This is great. But if one wants to change the caption - on say, a 
          keypress perhaps - then one would have to change the above mentioned array
          in order for the change to be reflected.

          So, we collect all the options first in a global array - oliveOil - and
          then set the local array variable used by Popeye to the requisite value
        */
        window.oliveOil = [] ;
        var previewIndex = 0 ;
        ...
        return this.each(function(){
            ...
            oliveOil.push(previewIndex, []) ;
            var last = 2*previewIndex + 1 ;
            var cap = oliveOil[last] ;

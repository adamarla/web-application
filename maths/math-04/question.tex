  ...
  \ifprintanswers
    \begin{marginfigure} 
      \begin{tikzpicture}[>=latex]
        \drawaxis{-2}{2}{-2}{2} ;
        \draw[color=black!70,thick] plot[smooth] file{q4/circle.table} ;
        \draw[color=black!70,thick] plot[smooth] file{q4/pos_root.table} ;
        \draw[color=black!70,thick] plot[smooth] file{q4/neg_root.table} ;

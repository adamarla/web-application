...
\ifprintanswers
  \begin{marginfigure}
    ...
    \end{tikzpicture} 
  \end{marginfigure} 
  \marginnote{This question sounds more complicated that it actually is.
  The key - as always - is to create a picture of what's happening. 
  Subsequent calculations are then rarely complicated}
